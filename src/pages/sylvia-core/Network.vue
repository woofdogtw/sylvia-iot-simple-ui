...
export default defineComponent({
  ...
  methods: {
    ...
    onAddOk() {
      ...
      let opts = {
        method: 'POST',
        url: `${config.coremgr.base}/api/v1/network`,
        headers: {
    ...
    onEditOk() {
      ...
      let opts = {
        method: 'PATCH',
        url: `${config.coremgr.base}/api/v1/network/${this.input.networkId}`,
        headers: {
          Authorization: `Bearer ${tokens.accessToken}`,
        },
        data: body,
    ...
    getCount() {
      ...
      let opts = {
        method: 'GET',
        url: `${config.coremgr.base}/api/v1/network/count?${qs.stringify(
          query
        )}`,
        headers: {
          Authorization: `Bearer ${tokens.accessToken}`,
    ...
    getNetwork(id, cb) {
      ...
      let opts = {
        method: 'GET',
        url: `${config.coremgr.base}/api/v1/network/${id}`,
        headers: {
          Authorization: `Bearer ${tokens.accessToken}`,
        },
      };
