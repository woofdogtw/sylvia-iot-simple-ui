...
export default defineComponent({
  ...
  methods: {
    ...
    onDeleteOk() {
      ...
      let opts = {
        method: 'DELETE',
        url: `${config.coremgr.base}/api/v1/dldata-buffer/${this.input.dataId}`,
        headers: {
    ...
    getCount() {
      ...
      let opts = {
        method: 'GET',
        url: `${config.coremgr.base}/api/v1/dldata-buffer/count?${qs.stringify(
          query
        )}`,
        headers: {
          Authorization: `Bearer ${tokens.accessToken}`,
    ...
    getList() {
      ...
      let opts = {
        method: 'GET',
        url: `${config.coremgr.base}/api/v1/dldata-buffer/list?${qs.stringify(
          query
        )}`,
        headers: {
          Authorization: `Bearer ${tokens.accessToken}`,
